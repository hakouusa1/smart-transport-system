                    ...
                    child: SingleChildScrollView(
                      ...
                      child: FadeTransition(
                        ...
                        child: SlideTransition(
                          ...
                          child: Column(
                            children: [
                              Text('Créer un compte', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w700, color: Colors.white)),
                              SizedBox(height: 6),
                                  ...
                                  child: Container(
                                    ...
                                    child: Form(
                                      ...
                                      child: Column(
                                        children: [
                                          _GlassField(
                                            controller: _nameController, label: 'Nom complet', hint: 'Ex: Mohamed Ali',
                                            icon: Icons.person_outline, action: TextInputAction.next,
                                            validator: (v) => v == null || v.trim().isEmpty ? 'Nom requis' : null,
                                          ),
                                          SizedBox(height: 14),
                                          _GlassField(
                                            controller: _emailController, label: 'Email', hint: 'owner@email.com',
                                          ...
                                          SizedBox(width: double.infinity, height: 52,
                                            child: ElevatedButton(
                                              ...
                                              style: ElevatedButton.styleFrom(backgroundColor: Colors.white, foregroundColor: context.appPrimary, elevation: 0,
...
class _GlassField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      onFieldSubmitted: onSubmit, style: TextStyle(color: Colors.white), validator: validator,
