          ...
          : StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.hasError) {
                  return Center(child: Text(l10n.errorFmt(snapshot.error.toString())));
                }
                ...
                if (docs.isEmpty) {
                  return Center(
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.history_outlined, size: 64, color: context.appSub.withValues(alpha: 0.2)),
...
class _HistoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final plan = SubscriptionPlan.getById(planId);
    final status = data['status'] ?? 'pending';
    final createdAt = data['createdAt'] as Timestamp?;
    final dateStr = createdAt != null ? l10n.formatDate(createdAt.toDate()) : '—';
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.workspace_premium_outlined, color: plan.color, size: 20),
              ),
          ...
          if (rejectionReason != null && rejectionReason.isNotEmpty) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: context.appRed.withValues(alpha: 0.1)),
              ),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Icon(Icons.info_outline, color: context.appRed, size: 16),
                  const SizedBox(width: 8),
                  Expanded(
                    child: Text(
                      rejectionReason,
                      style: TextStyle(fontSize: 13, color: context.appRed, height: 1.4),
                    ),
                  ),
                ],
              ),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Icons.receipt_long_outlined, color: context.appPurple, size: 16),
                    const SizedBox(width: 8),
                    Text(
                      l10n.uploadReceipt,
                      style: TextStyle(
