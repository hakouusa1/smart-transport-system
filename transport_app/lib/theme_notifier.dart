...
// Light values are defined first; dark overrides follow in ThemeColors extension.
// ─────────────────────────────────────────────────────────────────────────────

// Neutrals — light
const _lightBg        = Color(0xFFF5F5F5);
const _lightSurface   = Color(0xFFFFFFFF);
const _lightSurface2  = Color(0xFFF0F0F0);   // dropdown popup bg
...
const _darkBg         = Color(0xFF121212);   // scaffold
const _darkSurface    = Color(0xFF1E1E1E);   // cards, containers
const _darkSurface2   = Color(0xFF252525);   // elevated cards / dropdowns
const _darkSurface3   = Color(0xFF2C2C2C);   // pressed / active states
const _darkBorder     = Color(0xFF2E2E2E);   // subtle separator
const _darkTextPri    = Color(0xFFE1E3E6);   // off-white headers
const _darkTextSec    = Color(0xFF9DA3A9);   // silver-gray body / labels

// Accent — desaturated ~12% for dark vibrancy safety
const _accentBlueLt   = Color(0xFF1565C0);   // light primary
const _accentBlueDk   = Color(0xFF1154A8);   // dark primary  (–12% sat)
const _accentPurpleLt = Color(0xFF7C3AED);
const _accentPurpleDk = Color(0xFF6B34D4);   // –10% sat

// Semantics — jewel tones for dark, vivid for light
const _greenLt        = Color(0xFF2E7D32);
const _greenDk        = Color(0xFF28713A);   // deeper jewel
const _redLt          = Color(0xFFD32F2F);
const _redDk          = Color(0xFFB52929);   // less neon
const _orangeLt       = Color(0xFFF57C00);
const _orangeDk       = Color(0xFFCC6900);   // muted amber
const _tealLt         = Color(0xFF00B0FF);
const _tealDk         = Color(0xFF0096D6);   // desaturated
...
abstract final class AppTheme {
  ...
  static ThemeData _build(Brightness b) {
    ...
    return ThemeData(
      ...
      // ── Bottom nav bar — fully automatic in both modes ──
      ...
      pageTransitionsTheme: const PageTransitionsTheme(builders: {
        TargetPlatform.android: SmoothSlidePageTransitionBuilder(),
...
// Add new tokens here; update both branches together.
// ─────────────────────────────────────────────────────────────────────────────
extension ThemeColors on BuildContext {
  ...
  Color get appCardBg2  => isDark ? _darkSurface2  : _lightSurface2;   // dropdowns / elevated
  Color get appCardBg3  => isDark ? _darkSurface3  : const Color(0xFFE8E8E8); // active/pressed
  ...
  // ── Legacy aliases (kept so unchanged screens compile) ──
