...
/// Seen IDs are persisted to SharedPreferences so duplicate notifications
/// are not re-shown after an app restart.
    ...
    _sub = NotifyService.listenNotifications(uid).listen(
      (snap) async {
        ...
        if (newIds.isNotEmpty) {
          final prefs = await SharedPreferences.getInstance();
          // Keep last 200 IDs to prevent unbounded growth
